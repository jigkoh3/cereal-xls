...
const getOnlineOrders = new Promise((resolve, reject) => {
    ...
    request(options, function (error, response) {
        ...
        const result = res.data.filter((data) => {
            return data.payments.length > 0 && data.payments[0].billPaymentRef2 === 'CEREALORDER' && data.payments[0].transactionDateandTime.startsWith('2021-11-28')
...
getOnlineOrders.then((res) => {
    ...
    workbook.write('รายการจัดส่งซีเรียสซีเรียล-20211128.xlsx');
})
